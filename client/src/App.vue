<template>
  <div>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark positionNya">
      <a v-show="registerLoginPage" class="navbar-brand cursorNya" @click.prevent="abc">Mini Word Press</a>
      <a v-show="!registerLoginPage" class="navbar-brand cursorNya" @click.prevent="showHomePage">Mini Word Press</a>
      <button
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo02">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <div v-show="!registerLoginPage" @click="showProfilePage" class="img-frame-circle">
            <img
