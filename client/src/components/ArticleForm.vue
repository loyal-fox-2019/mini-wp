<template>
    <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
      ...
      <div class="mb-4">
        ...
        <input type="file" name="image" ref="file" @change="onFileChanged" class="w-full shadow-inner p-2 border-0" placeholder="Choose image file">
      </div>
      <div class="md:flex-1 px-3 text-center md:text-right">
          <input type="hidden" name="sponsor" value="0">
          <input @click.prevent="addArticle" class="button p-2 text-cream-300 bg-brick-500 hover:bg-brick-600" type="submit" value="Submit Article">
        </div>
      </form>
    </div>
</template>
