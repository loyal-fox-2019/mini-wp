<template>
  <div style="display:flex; justify-content:center;">
    <b-form class="col-md-10 mt-4">
      ...
      <b-form-group id="input-group-3" label="Tags" label-for="input-3" class='mt-4'>
        <b-form-tags
          v-model="tags"
          separator=" "
      ...
      <div class="d-flex mt-5">
        <b-button type="submit" variant="primary" @click.prevent='submitPost'>Post</b-button>
