    ...
    <div v-for="article in myArticles" :key="article._id" class="mb-4 mx-auto max-w-xl rounded overflow-hidden shadow-lg bg-white">
      <div class="relative z-0">
        ...
        <svg
          ...
          class="cursor-pointer fill-current absolute top-0 right-0 mx-1 text-white h-8 w-8" 
        ...
        <div v-if="openedToggles.includes(article._id)" class="absolute bg-blue-500 top-0 right-0 text-white mt-8 p-4 overflow-auto z-10">
          <a href="#" class="flex items-center p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"><i class="mr-1 fa fa-user fa-fw"></i>View</a>
          <a href="#" class="flex items-center p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"><i class="mr-1 fa fa-cog fa-fw"></i>Edit</a>
